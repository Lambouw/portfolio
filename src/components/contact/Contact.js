            ...
            <div className='contact white' >    
                ...
                <div className='form-wrapper' >
                    <form className='contact-form' action='https://formsubmit.co/jm.lindemann@web.de' method='POST'>
                        ...
                        <input className='input-name' type='text' name='name' placeholder='Name' required></input>
                        <input className='input-email' type='email' name='email' placeholder='Email' required></input>
                        <textarea className='input-message' type='text' name='Message' placeholder='Deine Nachricht' required ></textarea>
